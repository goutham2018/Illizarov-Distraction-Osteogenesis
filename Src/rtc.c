...
void rtc_init(void)
{
  ...
  if (HAL_RTC_Init(&RtcHandle) != HAL_OK)
  {
   /* Initialization Error */
		...
		Error_Handler(201); // See "error codes.txt"
  }
}
...
{
// TODO: 
// For Alarm A :	set demand value based on number of iterations per day and set isDemandChanged bit and also next alarm
//   if (mode==TEST)
//   alarm_works = RESET;
...
{
// TODO: 
// For Alarm B :  see EMERGENCY STOP in sys_func.c implement accordingly
}
